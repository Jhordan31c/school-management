...
export function Sidenav({ brandImg = "@/assets/img/college.png", brandName = "Apostol Santiago", routes }) {
  ...
  const sidenavTypes = {
    ...
    "blue-dark": "bg-blue-dark", // Add the new color option
  };
